...
with tab1:
    ...
    if query:
        ...
        if res.empty:
            ...
            # ✅ Affichage 2 colonnes : encadré général à gauche, série à droite
            ...
            # ✅ DÉTAIL inchangé (tu peux le garder ou le supprimer si tu veux)
            with st.expander("📌 DÉTAIL", expanded=False):
                ...
                if not (s1 or s2):
                    st.info("Pas de numéro de série enregistré")
                else:
